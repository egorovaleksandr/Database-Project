...
insert into dealership.customer (customer_id, full_name, phone_number)
...
insert into dealership.customer (customer_id, full_name, phone_number)
values (9, 'Кожухов Тимур Юрьевич', '+79194234312');
insert into dealership.customer (customer_id, full_name, phone_number)
values (10, 'Форсажев Доминик Тореттович', '+88003141592');

select * from dealership.customer;

insert into dealership.seller (seller_id, full_name, phone_number)
...
select * from dealership.seller;

insert into dealership.maker (maker_id, country, company)
...
select * from dealership.maker;

insert into dealership.model (model_id, model_name, color, number_of_seats, engine)
...
select * from dealership.model;

insert into dealership.price (model_id, price, date_from, date_to)
...
select * from dealership.price;

insert into dealership.automobile (automobile_id, car_brand, maker_id, model_id)
values (1, 'BMW', 3, 1);
insert into dealership.automobile (automobile_id, car_brand, maker_id, model_id)
values (2, 'BMW', 3, 2);
insert into dealership.automobile (automobile_id, car_brand, maker_id, model_id)
...
select * from dealership.automobile;

insert into dealership.payment (pay_id, pay_method, pay_date, account_number, receipt_size)
...
select * from dealership.payment;

insert into dealership.service_info (service_id, seller_id, automobile_id, service_date, pay_id)
...
select * from dealership.service_info;

insert into dealership.service (customer_id, service_id, automobile_id)
values (10, 3, 9);
insert into dealership.service (customer_id, service_id, automobile_id)
values (4, 1, 10);
insert into dealership.service (customer_id, service_id, automobile_id)
...
select * from dealership.service;
